...
ActiveRecord::Schema.define(version: 2021_06_21_173197) do
  ...
  create_table "punch_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.decimal "geo_latitude", precision: 10, scale: 6, default: "0.0", null: false
    t.decimal "geo_longitude", precision: 10, scale: 6, default: "0.0", null: false
    t.integer "geo_status", default: 0, null: false
  end
